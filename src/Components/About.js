    ...
    <section className="about-section">
      <div className="about-page-user">
        ...
        <div className="article-about">
            <article className="about-info">Hello, Traveler, and welcome to the Dendrology Project. I am part of a group of scientists working to preserve the planet called Earth and the many species of flora that populate it's surface. This is no easy task, as the planet has been ravaged by industry, yet the burden of knowledge weighs upon us to act. The conservation of the planet is our priority. So, I ask you, will you join us?</article>
            <article className="about-info-two">To start testing, select "ENTER APP" located on the right upper quadrant of your screen device. You will be prompted to complete a series of dendrological questions pertaining to this planet. You can review your incorrect questions at any time by selecting the "REVIEW" tab located in the navigation bar above. May the stars be in your favor.</article>
          </div>
      </div>
