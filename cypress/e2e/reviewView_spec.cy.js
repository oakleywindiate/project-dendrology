...
describe('Review page', () => {
    ...
    it('Should display a link to start testing while viewing the review page', () => {
      cy.contains('TEST').click().url().should('eq', 'http://localhost:3000/test')
    })
  
    it('Should display a link to review questions while viewing the review page', () => {
      cy.contains('REVIEW').click().url().should('eq', 'http://localhost:3000/review')
    })
  
    it('Should display a link to the "About" page while viewing the review page', () => {
